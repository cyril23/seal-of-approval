...
test.describe('Seal of Approval Game Tests', () => {
    ...
    test('can make the seal jump with spacebar', async ({ page }) => {
        ...
        await pressKey(page, 'Space'); // Double jump immediately after (includes 50ms wait)
        await page.waitForTimeout(100); // Brief additional wait to capture seal at peak height
